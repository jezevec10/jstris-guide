...
Jstris использует те же самые базовые механики, как и большинство похожих игр. Он использует правила оригинальной игры. Одной из основных особенностей является обширное использование повторов. Для каждой законченной вами игры будет создан повтор. Просмотр и анализ своих игр является неотъемлемой частью самосовершенствования, и повторы Jstris предоставляют вам такую возможность.
...
О: B2B = back-to-back (Спина-к-Спине). B2Bpm = back-to-back per minute (СкС в минуту). APM = attack per minute (атак в минуту). SPM = sent per minute (послано в минуту). PPS = pieces per second (фигур в секунду). Rep = replay (повтор).
